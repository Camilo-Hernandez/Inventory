...
fun ItemDetailsScreen(
    ...
    val itemUiState: ItemDetailsUiState by itemDetailsViewModel.uiState.collectAsStateWithLifecycle()
    ...
    Scaffold(
        topBar = {
            ...
            FloatingActionButton(
                onClick = { navigateToEditItem(itemUiState.itemDetails.id) },
        ...
        ItemDetailsBody(
            ...
            onSellItem = {
                itemDetailsViewModel.sellItem()
            },
            onDelete = {
                itemDetailsViewModel.deleteItemFromStock()
                navigateBack()
            },
            modifier = Modifier
